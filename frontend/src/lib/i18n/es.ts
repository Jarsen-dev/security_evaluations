...
export const es = {
  ...
  encabezado: {
    ...
    turnoDia: 'DÍA',
    turnoNoche: 'NOCHE',
    turnoDiaAyuda: 'Turno actual: día',
    turnoNocheAyuda: 'Turno actual: noche',
  },
  ...
  sqp: {
    ...
    descripcion:
      'Contesta los {total} puntos del formato. Un punto inconforme necesita ' +
      'observaciones.',
    encargado: 'Encargado',
    encargadoPlaceholder: 'Nombre de quien atiende el área',
    cargo: 'Cargo',
    cargoPlaceholder: 'Puesto del encargado',
    respuestaConforme: 'Conforme',
    respuestaInconforme: 'Inconforme',
    respuestaNa: 'N/A',
    ...
    faltanObservaciones: 'Hay {total} puntos inconformes sin observaciones.',
    ...
    hallazgos: 'Hallazgos',
    hallazgosDetalle: '{total} inconformes',
    descargarExcel: 'Descargar en Excel',
  ...
  borrador: {
    deOtroDia:
      'Este borrador se capturó el {fecha}. Revísalo antes de confirmar: la hoja se guarda con la fecha de hoy.',
    reiniciar: 'Reiniciar hoja',
    confirmarTitulo: '¿Reiniciar la hoja?',
    confirmarMensaje:
      'Se borrará todo lo capturado, incluidas las fotos que todavía no se han subido. No se puede deshacer.',
  },

  cierre: {
    titulo: 'Cierre de hallazgo',
    abrir: 'Cierre de hallazgo',
    verDetalle: 'Ver detalle',
    detalleTitulo: 'Detalle del registro',
    problemas: 'Problemas detectados',
    sinProblemas: 'Este registro no tiene hallazgos.',
    horaHallazgo: 'Hora de hallazgo',
    ubicacion: 'Ubicación',
    descripcion: 'Descripción',
    descripcionAyuda: 'Se toma de las observaciones del hallazgo; no se captura.',
    accionInmediata: 'Acción inmediata realizada',
    accionInmediataPlaceholder: '¿Qué se hizo para resolver el problema?',
    responsableAccion: 'Departamento o persona responsable',
    responsableAccionPlaceholder: 'Quién se encargó de la solución',
    horaCierre: 'Hora de cierre',
    verificacion: 'Verificación',
    verificacionAyuda: 'Evidencia de que el problema quedó resuelto.',
    accionPendiente: 'Acción pendiente',
    accionPendienteAyuda: 'Opcional: qué quedó sin concluir y por qué.',
    guardar: 'Guardar cierre',
    guardado: 'Cierre guardado.',
    actualizado: 'Cierre actualizado.',
    faltanCampos: 'Faltan campos por capturar.',
    cerrado: 'Cerrado',
    pendiente: 'Pendiente',
    registradoPor: 'Cerrado por {responsable}',
  ...
  incidencias: {
    titulo: 'Incidencias',
    descripcion:
      'Todo lo que salió mal en los controles, con su evidencia y su cierre.',
    control: 'Control',
    identificacion: 'Identificación',
    problemas: 'Problemas',
    estado: 'Estado',
    todosLosControles: 'Todos los controles',
    todosLosEstados: 'Todos los estados',
    vacio: 'No hay incidencias en este periodo.',
    conPendiente: 'Cerrado, con acción pendiente',
  },
  ...
  checklist: {
    ...
    descripcion:
      'Marca cada punto. Un punto inconforme necesita observaciones y ' +
    ...
    faltanObservaciones: 'Hay {total} puntos inconformes sin observaciones.',
    faltanFotos: 'Hay {total} puntos inconformes sin foto.',
    guardado: 'Registro guardado.',
    eliminado: 'Registro eliminado. Ya puedes capturarlo de nuevo.',
  ...
  recepciones: {
    ...
    descripcion:
      'Fotografía la remisión del proveedor: la IA extrae los campos, lo que no ' +
      'pueda leer queda resaltado para que lo captures, y la foto se guarda ' +
      'siempre como evidencia.',
    subirFoto: 'Subir o tomar foto',
    conCelular: 'Tomar con el celular',
    procesando: 'Analizando el documento con IA…',
    procesandoDetalle: 'Puede tardar entre 30 y 90 segundos según la carga del servidor.',
    fotoInvalida: 'El archivo debe ser una imagen.',
    falloProcesar: 'No se pudo procesar la foto.',
    revisaLaFoto: 'Revisa contra la foto',
    sinLeer: 'La IA no pudo leerlo — captúralo de la foto',
    avisoManual:
      'La IA no pudo leer el documento, pero la foto ya se guardó. Captura los ' +
      'campos a mano.',
    proveedor: 'Proveedor',
    folio: 'Folio o remisión',
    ...
    formatoNuevo: 'Formato no reconocido',
    formatoNuevoAyuda:
      'Ponle nombre a este formato para que el sistema lo reconozca la próxima vez.',
    nombreFormato: 'Nombre del formato',
    formatoDetectado: 'Formato reconocido: {formato}',
    otroDocumento: 'Añadir otro documento',
    quitarDocumento: 'Quitar este documento',
    documento: 'Documento {numero}',
    guardar: 'Guardar recepción',
    guardarTodo: 'Guardar {total} documento(s)',
    guardado: 'Recepción registrada y existencias actualizadas.',
    falloGuardar: 'No se pudo guardar la recepción.',
    yaGuardados: '{total} documento(s) ya guardado(s). {error}',
    cancelar: 'Descartar y empezar de nuevo',
    faltaCodigo: 'Escribe el código.',
    faltaCantidad: 'Escribe una cantidad mayor que cero.',
    faltaFormato: 'Ponle nombre al formato.',
    sinPartidas: 'Agrega al menos una partida.',
    qrTitulo: 'Tomar la foto con el celular',
    qrAyuda:
      'Escanea este código con la cámara del celular, toma la foto de la ' +
      'remisión y regresa aquí: la foto llega sola.',
    qrEsperando: 'Esperando la foto…',
    ...
    sinCoincidencias: 'Ninguna recepción coincide con los filtros.',
    falloCarga: 'No se pudo cargar el historial.',
    registros: '{total} recepción(es)',
  ...
  estudios: {
    titulo: 'Estudios',
    descripcion:
      'Estudios normativos y capacitaciones con vigencia: qué despacho los ' +
      'hace, en qué estatus van y cuándo vencen.',
    nuevo: 'Nuevo estudio',
    editando: 'Editando un estudio',
    despacho: 'Despacho',
    estudio: 'Estudio',
    estudioKo: 'Estudio (coreano)',
    estudioKoAyuda: 'Opcional. Es la columna 한국어 de la hoja.',
    vigencia: 'Vigencia',
    prioridad: 'Prioridad',
    tipo: 'IN/EX',
    estatus: 'Estatus',
    ...
    pagado: 'Pagado',
    link: 'Link',
    linkAyuda: 'Ruta o dirección donde quedó el estudio terminado.',
    confirmar: 'Confirmar',
    guardarCambios: 'Guardar cambios',
    cancelarEdicion: 'Cancelar la edición',
    numero: 'No.',
    registros: 'Estudios capturados',
    vacio: 'Todavía no hay estudios capturados.',
    vacioAyuda: 'Da de alta el primero con el formulario de arriba.',
    abrirLink: 'Abrir el estudio',
    guardado: 'Estudio agregado.',
    actualizado: 'Estudio actualizado.',
    eliminado: 'Estudio eliminado.',
    falloCarga: 'No se pudieron cargar los estudios.',
    confirmarEliminar: 'Eliminar estudio',
    confirmarEliminarDetalle:
      'El renglón se borra de la tabla y del Excel. Esta acción no se puede ' +
      'deshacer.',
    faltaDespacho: 'Escribe el despacho que hace el estudio.',
    faltaEstudio: 'Escribe el nombre del estudio.',
    faltaFecha: 'Elige la fecha en la que vence el estudio.',
    faltaLink: 'Escribe el link al estudio terminado.',
    faltanCampos: 'Elige una opción en cada campo antes de confirmar.',
    opciones: {
      vigencia: {
  ...
  catalogo: {
    ...
    todosLosEstados: 'Todos los estados',
    limpiar: 'Limpiar filtros',
    buscarAyuda: 'Buscar por código, descripción, proveedor o ubicación…',
